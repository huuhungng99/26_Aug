...
sys.path.append('E:\Main_interface_v13\labelImg_master')
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        self.defaultSaveDir = os.path.abspath('.')
        ...
        addActions(self.menus.file,    (open, openAnnotation, self.menus.recentFiles, save, saveAs, close, resetAll,deleteImg, quit))
    ...
    def newShape(self):
        ...
        """
        # Doc du lieu object nao dang duoc chon
        db_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'database.db')
        self.conn = sqlite3.connect(db_path)
        self.cursor = self.conn.cursor()
        self.cursor.execute("SELECT object_name FROM commands WHERE selected = 'ON'")
        ...
        if not self.useDefaultLabelCheckbox.isChecked() or not self.defaultLabelTextLine.text():
            ...
            if self.singleClassMode.isChecked() and self.lastLabel:
                ...
                #text = self.labelDialog.popUp(text='test_code')
                text = self.labelDialog.popUp(text=result[0])
                self.lastLabel = text
        else:
    ...
    def saveFile(self, _value=False):
        if self.defaultSaveDir is not None and len(ustr(self.defaultSaveDir)):
            if self.filePath:
                ...
                savedFileName = 'start_stop_coordinate'
